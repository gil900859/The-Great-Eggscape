...
export const JUMP_STRENGTH = -10.5; 
export const BASE_JUMP_STRENGTH = -7.5; 
export const DASH_BOOST = 2.5; 
export const JUMP_BOOST_MULTIPLIER = 1.6; 
export const DASH_BUFF_DURATION = 2000; 
export const MAX_JUMP_TIME = 20; 
export const DUCK_FLY_STRENGTH = -12;
export const GLIDE_GRAVITY_FACTOR = 0.12;
